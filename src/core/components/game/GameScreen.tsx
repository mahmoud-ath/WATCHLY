      ...
      <div className="glass border border-border/20 rounded-2xl p-6 backdrop-blur-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className={`glass border border-border/20 px-3 py-1.5 rounded-full text-sm font-medium text-white ${getDifficultyColor(question.difficulty || 'medium')}`}>
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-bold ${
                      selectedAnswer !== null 
                        ...
                        : 'bg-primary text-white group-hover:scale-110 transition-transform'
                    }`}>
