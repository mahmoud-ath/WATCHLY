        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="lg:w-2/5 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-4 text-center lg:text-left">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4">
                <div className="w-16 h-16 bg-primary rounded-xl flex items-center justify-center shadow-xl shadow-primary/25">
          ...
          <div className="lg:w-3/5 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-4">
              <button 
                onClick={onStartGame}
                className="bg-primary text-white w-full py-4 rounded-xl font-bold text-lg transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:shadow-primary/25 group flex items-center gap-3 justify-center"
              >
