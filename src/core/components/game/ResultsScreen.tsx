  ...
  return (
    <div className="text-center space-y-8 animate-in fade-in duration-500">
      ...
      <div className={`glass border ${result.borderColor} rounded-2xl p-8 backdrop-blur-sm`}>
        {/* Result Icon */}
        <div className={`w-24 h-24 rounded-3xl ${result.color} flex items-center justify-center mx-auto mb-6 shadow-lg`}>
        ...
        <div className="w-full bg-surface-elevated rounded-full h-3 mb-6 overflow-hidden">
          <div 
            className={`h-3 rounded-full ${result.color} transition-all duration-1000`}
